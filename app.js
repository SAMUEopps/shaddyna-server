...
//const brainTreeRouter = require("./routes/braintree").default;
...
// CORS Configuration
const allowedOrigins = ['http://192.168.0.109:3000','http://localhost:3000', 'https://shaddyna-client.onrender.com'];
app.use(cors({
